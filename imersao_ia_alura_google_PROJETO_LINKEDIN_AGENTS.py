...
def call_agent(agent: Agent, message_text: str) -> str:
    ...
    # Usamos InMemorySessionService para simular a sessão em um script único
...
def agente_planejador(topico, assuntos_buscados):
    ...
    planejador = Agent(
        ...
        - Use a ferramenta de busca do Google (Google Search) para encontrar mais informações sobre os temas e aprofundar seu entendimento.
